    ...
    <div className="bg-grey-900">
      <div className="flex h-[23.3rem] items-center justify-center p-5">
        ...
        <div className="w-[20rem]">
          ...
          <div className="mt-7 text-center">
            <button className="btn-primary btn h-14 w-[90%] text-xl">확인</button>
          </div>
        </div>
      </div>
      ...
      <div className="flex h-80 items-center justify-center p-5">
        <div className="w-[20rem] ">
          ...
          <div className="mt-7 text-center">
            <button className="btn-primary btn h-14 w-[90%] text-xl">그룹타이머 만들기</button>
          </div>
        </div>
      </div>
    </div>
